...
SECRET_KEY = 'django-insecure-secret-key-for-demo-only'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['hotpot-demo.zeabur.app']
...
INSTALLED_APPS = [
    ...
    'apps.liff_interface.apps.LiffInterfaceConfig',
...
# Line LIFF settings (demo values)
LINE_LIFF_ID = '1234567890-abcdefgh'
LINE_CHANNEL_ACCESS_TOKEN = 'demo_channel_access_token'
LINE_CHANNEL_SECRET = 'demo_channel_secret'
